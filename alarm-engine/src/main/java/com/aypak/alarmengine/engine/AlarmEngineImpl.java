package com.aypak.alarmengine.engine;

import com.aypak.alarmengine.batch.BatchDBExecutor;
import com.aypak.alarmengine.core.AlarmEvent;
import com.aypak.alarmengine.monitor.AlarmMetrics;
import com.aypak.alarmengine.nodes.*;
import com.aypak.flowengine.ShardedFlowEngine;
import com.aypak.flowengine.ShardedFlowEngineBuilder;
...
public class AlarmEngineImpl implements AlarmEngine {
    ...
    public AlarmEngineImpl(DataSource dataSource, String insertSql,
        ...
        com.aypak.flowengine.core.RejectPolicy flowRejectPolicy = mapRejectPolicy(rejectPolicy);
     ...
     */
    private com.aypak.flowengine.core.RejectPolicy mapRejectPolicy(RejectPolicy policy) {
        switch (policy) {
            case DROP:
                return com.aypak.flowengine.core.RejectPolicy.DROP;
            case BLOCK:
                return com.aypak.flowengine.core.RejectPolicy.BLOCK;
            case CALLER_RUNS:
                return com.aypak.flowengine.core.RejectPolicy.CALLER_RUNS;
            case DROP_OLDEST:
                return com.aypak.flowengine.core.RejectPolicy.DROP_OLDEST;
            default:
                return com.aypak.flowengine.core.RejectPolicy.DROP;
        }
    }
