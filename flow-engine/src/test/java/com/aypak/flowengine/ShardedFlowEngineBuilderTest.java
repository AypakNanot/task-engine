package com.aypak.flowengine;

import com.aypak.flowengine.core.FlowConfig;
...
import com.aypak.flowengine.core.ShardingStrategy;
    ...
    void shouldHandleCriticalNodeCorrectly() throws Exception {
        ...
        ShardedFlowEngine<String, String> engine = ShardedFlowEngine.<String, String>builder()
                .addNode(new FlowNode<String, String>() {
                    ...
                    @Override
                    public boolean process(FlowEvent<String, String> event, com.aypak.flowengine.core.FlowContext context) {
                        latch.countDown();
