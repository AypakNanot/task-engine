...
import com.aypak.taskengine.alarm.engine.AlarmEngine;
import com.aypak.taskengine.alarm.engine.AlarmEngineImpl;
...
public class AlarmEngineAutoConfiguration {
    ...
    private com.aypak.taskengine.alarm.core.RejectPolicy parseRejectPolicy(String policyStr) {
        try {
            return com.aypak.taskengine.alarm.core.RejectPolicy.valueOf(policyStr.toUpperCase());
        } catch (IllegalArgumentException e) {
            log.warn("Invalid reject policy: {}, defaulting to DROP", policyStr);
            return com.aypak.taskengine.alarm.core.RejectPolicy.DROP;
        }
    }
}
